    ...
    <section id="slider">
      <div id="home-carousel" className="carousel slide" data-ride="carousel">
        <div className="carousel-inner">
          ...
          <div className="item" style={{backgroundImage:"url('images/Slider/02.jpg')"}}>
            <div className="carousel-caption container">
              <div className="row">
                <div className="col-md-7 col-sm-12 col-xs-12">
                  <h1>We Are Cosmix</h1>
          ...
          <div className="item" style={{backgroundImage:"url('images/Slider/03.jpg')"}}>
            <div className="carousel-caption container">
              <div className="row">
                <div className="col-md-7 col-sm-12 col-xs-12">
                  <h1>We Are Cosmix</h1>
          ...
          <a className="home-carousel-left" href="#home-carousel" data-slide="prev">
